...
private final PIDUptoHeight pID1 = new PIDUptoHeight(elevator, 20);
private final PIDUptoHeight pID2 = new PIDUptoHeight(elevator, 10);
private final PIDUptoHeight pID3 = new PIDUptoHeight(elevator, 5);
