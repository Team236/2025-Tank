...
public class PIDGyroTurnCCW extends Command {
  private final Drive drive;
  private final PIDController gyroPidController;
  private AHRS navx;

  /** Creates a new PIDGyroTurnCCW. */
  public PIDGyroTurnCCW(Drive drive, AHRS navx, double setpointDegrees) {
      this.navx = navx;
      this.drive = drive;
      this.gyroPidController = new PIDController(Constants.DriveConstants.KP_GYRO_TURN_CCW, 0, 0);
